...
const styles = StyleSheet.create({
  container: {
    position: 'absolute',
    right: 20,
    bottom: 20, // Position plus basse pour le web mobile
    backgroundColor: 'transparent', // Fond transparent pour éviter les coins blancs
  } as any,
  fab: {
    alignItems: 'center',
    ...
    borderRadius: 28,
    minWidth: 120,
    // Pas d'ombre pour éviter les coins blancs sur le web
  } as any,
  mainText: {
    fontSize: 16,
    fontWeight: '700',
