...
export const BookingFooter = memo<BookingFooterProps>(
  ({
    ...
    return (
      <View style={[profileStyles.bookingButtonContainer, { paddingBottom: insets.bottom + 12 }]}>
        {/* Prix */}
        ...
        <View style={profileStyles.playersSelector}>
          <TouchableOpacity
            style={[
              profileStyles.playerButton,
              !canDecrementPlayers && profileStyles.playerButtonDisabled,
            ]}
            ...
            accessibilityValue={{
              ...
              max: 3,
              now: players,
              text: `${players} joueur${players > 1 ? 's' : ''}`,
            }}
          >
            <Ionicons
              name="remove"
          ...
          >
            <Text style={profileStyles.playersNumber} accessibilityElementsHidden={true}>
              {players}
            </Text>
          ...
          <TouchableOpacity
            style={[
              profileStyles.playerButton,
              !canIncrementPlayers && profileStyles.playerButtonDisabled,
            ]}
            onPress={() => onPlayersChange(players + 1)}
