-- Fonction RPC pour récupérer toutes les données d'un profil pro en une seule requête
...
CREATE INDEX IF NOT EXISTS idx_pro_availabilities_pro_date 
ON pro_availabilities(pro_id, date) 
WHERE is_available = true;

CREATE INDEX IF NOT EXISTS idx_pro_pricing_pro_id 
ON pro_pricing(pro_id);

CREATE INDEX IF NOT EXISTS idx_bookings_pro_id_status 
