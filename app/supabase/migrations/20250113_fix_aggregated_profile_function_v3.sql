-- Correction finale de la fonction RPC - Suppression des colonnes inexistantes
-- Corrige l'erreur "column pp.certifications does not exist"
...
Version corrigée avec seulement les colonnes existantes dans la base de données.
