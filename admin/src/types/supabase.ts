...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      bookings: {
        Row: {
          ...
          player3_first_name: string | null
          player3_last_name: string | null
          pro_fee: number
          pro_id: string
      ...
      user_course_alerts: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_course_alerts_golf_course_id_fkey"
            columns: ["golf_course_id"]
            isOneToOne: false
            referencedRelation: "golf_parcours"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "user_course_alerts_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      decrement_availability_bookings: {
        Args: { p_availability_id: string; p_num_players?: number }
        Returns: undefined
      }
